            ...
            <html lang="en" dir="ltr">
                    ...
                    <div class="maincontainer">
                        ...
                        <div id="Music-player">
                            ...
                            <div id="Side-panel">
                                ...
                                <div id="playlist">
                                    <div class="Music"><a href="" onclick="Video(0)"><span>🎧 </span> Eminem - Godzilla</a></div>
                                    <div class="Music"><a href="" onclick="Video(1)"><span>🎧 </span> Eminem - RapGod</a></div>
                                    <div class="Music"><a href="" onclick="Video(2)"><span>🎧 </span> Joyner Lucas - ISIS</a></div>
                ...
                <script>
                    ...
                    function Video(index){
                        player.loadVideoById(videos[index].vid, 0, "default");
                    }
