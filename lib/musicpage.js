module.exports = {
    HTML: function (music_title, videolinkcode, musics, page_url, music_title, artist_name, musictype, nextmusic_title) {
        return `
            <!DOCTYPE html>
            <html lang="en" dir="ltr">
                    ...
                    <div class="maincontainer">
                        ...
                        <div id="Music-player">
                            <div id="Main-panel">
                                <div class="no_video">
                                    <div id="player"></div>
                                    <div id="Music_name">${artist_name} - ${music_title}</div>
                                </div>
                            </div>
                            <div id="Side-panel">
                ...
                var player;
                    ...
                    function onPlayerStateChange(event) {
                        if (event.data === 0) {
                            window.close("${page_url}")
                            window.open("../${musictype}/${nextmusic_title}", "_self")
