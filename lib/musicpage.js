module.exports = {
    HTML: function (music_title, videolinkcode, musics, page_url, music_title, artist_name, musictype, nextmusic_title, nextmusic_linkcode) {
        return `
            <!DOCTYPE html>
